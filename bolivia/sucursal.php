...
$stmt = $pdo->prepare("SELECT * FROM sucursales WHERE estado = 1 ORDER BY id DESC");
$stmt->execute();
$sucursales_db = $stmt->fetchAll(PDO::FETCH_ASSOC);

// 2. Obtener fotos
$fotos_db = $pdo->query("SELECT * FROM sucursal_fotos WHERE estado = 1")->fetchAll(PDO::FETCH_ASSOC);
?>
...
<div class="contenedor-mapa-global">
    ...
    <div class="overlay-titulo-flotante">
        ...
        <p>El sabor de El Solar, cerca de ti</p>
    </div>
    ...
    <div id="card-detalle-solar" class="hidden">
        ...
        <div class="detalle-info">
            ...
            <a id="btn-maps-link" href="#" target="_blank" class="btn-rojo-solar">VER EN MAPS</a>
        </div>
    </div>
</div>
